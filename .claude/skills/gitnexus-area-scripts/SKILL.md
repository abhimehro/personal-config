...
description: "Skill for the Scripts area of personal-config. 266 symbols across 25 files."
---

# Scripts

266 symbols | 25 files | Cohesion: 81%
...
| `scripts/pr_lifecycle_pipeline_health.py`                    | _accept_runtime_ledger, _has_runtime_ledger_shape, _is_bootstrap_pointer_document, _is_list_or_missing, _load_runtime_ledger (+27)        |
...
- **`validate_approval`** (Function) — `scripts/pr_lifecycle_ledger.py:547`
- **`validate_approved_calibration`** (Function) —
  `scripts/pr_lifecycle_ledger.py:559`
- **`validate_imports`** (Function) — `scripts/pr_lifecycle_ledger.py:624`
...
| `validate_approval`                | Function | `scripts/pr_lifecycle_ledger.py` | 547  |
| `validate_approved_calibration`    | Function | `scripts/pr_lifecycle_ledger.py` | 559  |
| `validate_imports`                 | Function | `scripts/pr_lifecycle_ledger.py` | 624  |
| `validate_item`                    | Function | `scripts/pr_lifecycle_ledger.py` | 88   |
| `validate_item_guardrail_outcome`  | Function | `scripts/pr_lifecycle_ledger.py` | 138  |
| `validate_item_owner`              | Function | `scripts/pr_lifecycle_ledger.py` | 143  |
| `validate_item_state`              | Function | `scripts/pr_lifecycle_ledger.py` | 129  |
| `validate_items`                   | Function | `scripts/pr_lifecycle_ledger.py` | 79   |
| `validate_known_merge_method`      | Function | `scripts/pr_lifecycle_ledger.py` | 673  |
| `validate_merge_method_entry`      | Function | `scripts/pr_lifecycle_ledger.py` | 644  |
| `validate_merge_methods`           | Function | `scripts/pr_lifecycle_ledger.py` | 635  |
| `validate_revoked_calibration`     | Function | `scripts/pr_lifecycle_ledger.py` | 578  |
| `validate_runtime_records`         | Function | `scripts/pr_lifecycle_ledger.py` | 70   |
| `validate_verified_merge_evidence` | Function | `scripts/pr_lifecycle_ledger.py` | 678  |
| `validate_verified_merge_hold`     | Function | `scripts/pr_lifecycle_ledger.py` | 683  |
| `validate_verified_merge_method`   | Function | `scripts/pr_lifecycle_ledger.py` | 667  |
| `validate_work_item_evidence`      | Function | `scripts/pr_lifecycle_ledger.py` | 619  |
| `validate_work_item_identity`      | Function | `scripts/pr_lifecycle_ledger.py` | 593  |
...
| `_accept_runtime_ledger → Require_mapping`       | cross_community | 8     |
| `Main → BareArrayReplacement`                    | cross_community | 7     |
| `_accept_runtime_ledger → Validate_item_anchors` | cross_community | 7     |
| `_accept_runtime_ledger → Validate_item_key`     | cross_community | 7     |
