...
| **9:00 AM** | 📅 Weekly Maintenance | Monday | `weekly_maintenance.sh` | Node modules, OneDrive monitoring, backup discovery |
...
- ✅ ProtonDrive backup discovery (automatic file/directory detection)
