...
def _build_graphql_query(batch):
    query_parts = []
...
if __name__ == "__main__":
    # ⚡ Bolt Optimization: Replace N+1 subprocess calls and API requests with a single batched GraphQL query
    all_prs = _fetch_all_prs_graphql(repos)
