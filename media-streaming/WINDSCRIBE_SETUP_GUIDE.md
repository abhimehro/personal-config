...
curl -u "infuse:[REDACTED_PASSWORD]" http://127.0.0.1:8080/
```
...
curl -u "infuse:[REDACTED_PASSWORD]" http://192.168.0.111:8080/
```
...
```bash
curl -u "infuse:[REDACTED_PASSWORD]" http://82.21.151.194:22650/
```
