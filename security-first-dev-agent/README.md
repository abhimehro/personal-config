...
> 💡 **Tip:** Use [Gemini CLI](https://github.com/google-gemini/gemini-cli) for
> AI-assisted development - project context is pre-configured in `GEMINI.md`.
...
You can also use features from the [ADK](https://adk.dev/) CLI with
`uv run adk`.
...
To add CI/CD and Terraform, run `agents-cli scaffold enhance`. To set up your
production infrastructure, run `agents-cli infra cicd`.
