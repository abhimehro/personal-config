...
resource "google_project_iam_member" "default_compute_sa_storage_object_creator" {
  # checkov:skip=CKV_GCP_46:Default Compute Engine service account is required by Cloud Build for deployment tasks
  # checkov:skip=CKV_GCP_49:This role is required by Cloud Build for tasks execution and is not overprivileged here
