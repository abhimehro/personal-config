...
Live re-fetch after Phase 1 remainder (`tasks/pr-review-2026-08-01.md`). Scope:
bot/automation PRs that are CONFLICTING/DIRTY (or prior deferred/escalated still
open).
