...
1. **Code health & performance** — technical debt, dead code, complex modules, easy wins (e.g. NumPy/Pandas vectorization).
...
- Run lightweight checks and full test suites when cheap; plan (don’t require) heavy builds.
