...
Living status board for the [Security Remediation Sprint](https://linear.app/abhis-space/project/security-remediation-sprint-3346e8289f29).  
Canonical agent instructions: [docs/AI_AGENT_SECURITY_REMEDIATION_GUIDE.md](../docs/AI_AGENT_SECURITY_REMEDIATION_GUIDE.md).
...
- **Credential rotation (ABHI-918):** Cannot be completed by agents without access to GitHub PAT settings or 1Password vaults. Run verification tests after human rotation.
