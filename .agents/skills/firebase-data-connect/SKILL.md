...
> [!NOTE]
> **Product Rename**: Firebase Data Connect was renamed to **Firebase SQL
> Connect**. All instructions, references, and examples in this skill repository
> referring to "Data Connect" or "Firebase Data Connect" apply to "SQL Connect"
> and "Firebase SQL Connect" as well.
...
3. Run `npx -y firebase-tools@latest dataconnect:compile` or
