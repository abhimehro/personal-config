...
description: "Skill for the Tests area of personal-config. 479 symbols across 50 files."
---

# Tests

479 symbols | 50 files | Cohesion: 85%
...
| `tests/test_pr_lifecycle_pipeline_health.py` | _item, _ledger, _work_item, test_attempt_count_zero_and_empty_optional_lists_are_usable, test_empty_required_strings_do_not_suppress_starvation (+16)                                                                                                  |
...
| `summarize`                 | Function | `scripts/pr_lifecycle_pipeline_health.py`      | 287  |
...
| `rewrite_triage_file`       | Function | `detect_duplicates.py`                         | 189  |
| `format_lists`              | Function | `generate_report.py`                           | 43   |
| `get_category`              | Function | `scratch_inventory.py`                         | 124  |
| `classify_pr_identity`      | Function | `scripts/pr_identity.py`                       | 101  |
| `sample_policy`             | Function | `tests/test_pr_identity.py`                    | 17   |
