...
2. **Check Existing MCP Configuration**: Run `claude mcp list -s user` and
...
4. **Add Marketplace**: Run the following command to add the marketplace (this
...
5. **Install Plugins**: Run the following command to install the plugin:
   ...
   ```
6. **Verify Installation**: Re-run the checks in steps 1 and 2 to confirm the
