...
<Note>
  The MCP client processes your queries locally and only transmits topic
  information needed to retrieve relevant documentation. Your full prompts,
  code, and context remain private.
</Note>
