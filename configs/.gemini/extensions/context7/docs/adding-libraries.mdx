...
<Note>
  For private repositories, see the [Private
  Repositories](/dashboard/private-repositories) guide. Requires a Pro or
  Enterprise plan.
</Note>
...
<Note>
  **Pro Tip**: Including the `$schema` field enables autocomplete, validation,
  and helpful tooltips in modern code editors like VS Code, making it easier to
  create and maintain your configuration.
</Note>
