...
This file documents portable patterns from `.zshrc` that can be ported to Fish
shell.

## Source Configuration

- **Source**:
  `/Users/speedybee/Documents/dev/personal-config.worktrees/normalize-gitignore-eol/configs/.zshrc`
