...
# ============================================
# Theme (Dracula) - Colors for syntax highlighting
# ============================================
# Dracula colors - compatible with common Zsh themes
if [[ -o interactive ]]; then
    # Syntax highlighting colors (if using zsh-syntax-highlighting plugin)
