...
spec = importlib.util.spec_from_file_location(
    ...
    os.path.abspath(
        os.path.join(
            ...
            "../media-streaming/archive/scripts/alldebrid-server.py",
        )
    ),
)
...
class TestHTTPResponseSplitting(unittest.TestCase):
    ...
    def test_origin_with_multiple_newlines_sanitized(self):
        ...
        self.assertEqual(
            len(cors_headers), 0, "Malicious origin should not match after sanitization"
        )
    ...
    def test_subdomain_bypass_attempt_blocked(self):
        ...
        self._test_origin_rejection(
            "http://example.com.evil.com", "Subdomain bypass attempt should be blocked"
        )
    ...
    def test_query_string_bypass_attempt_is_blocked(self):
