...
class TestHTTPResponseSplitting(unittest.TestCase):
    ...
    def test_subdomain_bypass_attempt_blocked(self):
        ...
        handler.headers = MagicMock()
        # Attacker tries to bypass by appending allowed domain as subdomain prefix
        handler.headers.get.return_value = 'http://example.com.evil.com'
    ...
    def test_path_based_bypass_attempt_blocked(self):
        ...
        handler.headers = MagicMock()
        # Attacker tries to bypass by including allowed domain in path
        handler.headers.get.return_value = 'http://evil.com/http://example.com'
    ...
    def test_query_string_bypass_attempt_blocked(self):
        ...
        handler.headers = MagicMock()
        # Attacker tries to bypass by including allowed domain in query string
        handler.headers.get.return_value = 'http://evil.com?ref=http://example.com'
