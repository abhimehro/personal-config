...
secure_mkdir() { mkdir -p "$1"; chmod "$2" "$1"; }
...
if ! test_setup_directories; then echo "test_setup_directories failed"; test_failed=1; fi
if ! test_safe_stop; then echo "test_safe_stop failed"; test_failed=1; fi
