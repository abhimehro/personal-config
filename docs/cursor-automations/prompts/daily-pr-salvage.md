...
attempt count, owner, creation event, and history all validate. Reject
incomplete work items rather than inferring missing scope.
...
test. A tested draft or structured failed-recovery record is success.
