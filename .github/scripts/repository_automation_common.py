...
def write_result(
    task: str, status_summary: tuple[str, str], body: str, extra: dict[str, Any] | None = None
) -> dict[str, Any]:
...
def _latest_tag_via_mcp(repo_id: str) -> str:
...
def latest_tag_for_action(repo_id: str) -> str:
    mcp_tag = _latest_tag_via_mcp(repo_id)
    if mcp_tag:
        return mcp_tag
    ...
    stable_tags = _stable_tags_from_json(tags_json)
