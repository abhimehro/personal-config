...
| `pr-visual-recap.yml` | PR lifecycle events | Visual/recap comment on PRs. Agents today: `claude` / `codex`. Alternate backends draft: `docs/pr-visual-recap-agent-backends.md` (OpenCode/Mistral preferred). |
