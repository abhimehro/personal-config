...
`disabled_manually` period. **Do not restore** unless there is a fresh, explicit
use case. Gemini CLI availability is shifting toward enterprise, and Google
Antigravity compatibility for these Actions is unproven — treat any restore as a
new design, not a rollback.
