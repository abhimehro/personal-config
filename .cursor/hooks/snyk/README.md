...
Vendored from the
[Snyk Secure Development](https://github.com/snyk/studio-recipes) Cursor plugin
(`guardrail_directives/secure_at_inception/hooks_version/cursor/async_cli_version/`).
