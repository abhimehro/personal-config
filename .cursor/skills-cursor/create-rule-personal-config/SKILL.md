---
name: create-rule-personal-config
description: Repo-local backup of the create-rule skill, tailored for personal-config. Use this when iterating on rule patterns or conventions specific to this repository while keeping the global create-rule skill unchanged.
---
